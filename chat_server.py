...
# ==============================================================================
                ...
                m = text_proc(msg["message"], from_name)
                messages = indexer.Index(from_name)
                messages.add_msg_and_index(m)
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    #self.indices[g]=self.indices[g].append(msg)
                    indexer.Index(g).add_msg_and_index(m)
...
# ==============================================================================
                ...
                ### asking for the 'who' call function
...
# ==============================================================================
                ...
                search_rslt = (self.indices[from_name].search(msg["target"])).strip()     # "needs to use self.indices search to work"

                #search_rslt = sonnet.search(from_name)
